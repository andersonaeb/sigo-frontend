          ...
          <CCardBody>
            ...
            <CForm onSubmit={handleSubmit} className="form-horizontal">
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                  <CInput id="companyName" name="companyName" placeholder="Empresa" required />                  
                </CCol>
              </CFormGroup>
              ...
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                  <CInput id="cnpj" name="cnpj" maxLength="14" placeholder="CNPJ" required />                  
                </CCol>
              </CFormGroup>
              ...
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">                  
                  <CSelect custom id="state" name="state" required>
              ...
              <CFormGroup row>
                ...
                <CCol xs="12" md="9">
                  <CInput id="city" name="city" placeholder="Cidade" required />                  
                </CCol>
              </CFormGroup>
